...
from models.schemas.department import SearchDepartmentSchema, DepartmentViewSchema
...
async def search_departments(data: SearchDepartmentSchema, skip: int, limit: int) -> tuple[list[DepartmentViewSchema], int]:
    """Search for departments

    Args:
        data (SearchDepartmentSchema): The search parameters
    ...
    query = query.order_by(DepartmentsView.c.name).limit(limit).offset(skip)
