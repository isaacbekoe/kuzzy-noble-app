...
from models.schemas.employee import SearchEmployeeSchema, EmployeeViewSchema
...
async def search_employees(data: SearchEmployeeSchema, skip: int, limit: int) -> tuple[list[EmployeeViewSchema], int]:
    """Search for employees

    Args:
        data (SearchEmployeeSchema): The search parameters
    ...
    query = query.order_by(EmployeesView.c.name).limit(limit).offset(skip)
