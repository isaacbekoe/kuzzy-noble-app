...
EmployeesTable = sa.Table(
    ...
    sa.UniqueConstraint(
        "employee_id",
        name="employees_employee_id_unique_constraint"),
    sa.UniqueConstraint(
        "email_address",
        name="employees_email_address_unique_constraint"),
    sa.UniqueConstraint(
        "phone_number",
        name="employees_phone_number_unique_constraint"),
)
